...
@WWWL5.on(admin_cmd(pattern="دعوه للمكالمه(?: |$)(.*)"))
async def _(e):
...
@WWWL5.on(admin_cmd(pattern="بدء مكالمه(?: |$)(.*)"))
async def _(e):
    try:
...
R = [
    ...
    "**-** مطور السورس **⪼ [فوكس🦊 ⌁ 🕷](t.me/Fox455664)   \n"
    "**-** قناة السورس **⪼ [𝗦𝗢𝗨𝗥𝗖𝗘 𝗦𝗣𝗜𝗗𝗘𝗥](t.me/Fox455664)   "
]

@WWWL5.on(admin_cmd(pattern="الالعاب$"))
...
@WWWL5.on(admin_cmd(pattern="اذكار$"))
async def ithker(knopis):
...
Citation1_morning = [
    ...
    "** كت تويت | اكثر مطور تحبه في فوكس🦊 منو ؟ **",

]


@WWWL5.on(admin_cmd(pattern="كت$"))
async def ithker(knopis):
...
@WWWL5.on(admin_cmd(pattern="خيروك$"))
async def ithker(knopis):
    await knopis.edit(choice(Jepthon_5erok))

    
@WWWL5.on(admin_cmd(pattern="اذكار عشر$"))    
...
@WWWL5.on(admin_cmd(pattern="شنو رأيك بهذا$"))
async def ithker(knopis):
...
@WWWL5.on(admin_cmd(pattern="بوسة$"))
async def ithker(knopis):
