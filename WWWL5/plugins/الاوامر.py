...
@WWWL5.ar_cmd(pattern="م15")
async def hi(event):
    await edit_or_reply(
        event,
        "⩹⌯⊷━♢ ⦓ ƚᥱᥣᥱƚ𝗁᥆ꪀ 𝐅𝐎𝐗&𝐍𝐎𝐑 𓅃⦔ ♢━⊶⌯⩺\n\nاوامر جلب الذاتية وامر الاضافة**:\n\n ◂  `.ضيف`\n❃ اكتب الامر مع رابط مجموعه التي تريد سحب اعضائها وارسل الامر في مجموعتك لسحبهم الى مجموعتك\n\n ◂ `.ذاتيه` او `.ذاتية`\n❃ بالرد على صورة او فيديو ذاتية التدمير لحفظها وارسالها في الرسائل المحفوظة بسرية تامة الامر ل سبايدر حصريا!\n⩹⌯⊷━♢ ⦓ ƚᥱᥣᥱƚ𝗁᥆ꪀ 𝐅𝐎𝐗&𝐍𝐎𝐑 𓅃⦔ ♢━⊶⌯⩺",
    )


@WWWL5.ar_cmd(pattern="م16")
async def hi(event):
    await edit_or_reply(
        event,
